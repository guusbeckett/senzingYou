...
//						| ((head[20]) & 0x00000FF);
			...
			try
			{
				...
				aff_properties.put("mp3.version.layer",
						Integer.toString(nLayer));
				...
				aff_properties.put("mp3.vbr.scale",
						new Integer(m_header.vbr_scale()));
				...
				aff_properties.put("mp3.copyright",
						new Boolean(m_header.copyright()));
				aff_properties.put("mp3.original",
						new Boolean(m_header.original()));
				aff_properties
						.put("mp3.crc", new Boolean(m_header.checksums()));
				aff_properties.put("mp3.padding",
						new Boolean(m_header.padding()));
